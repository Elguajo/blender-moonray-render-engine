...
- [>] Phase 02 — Windows/WSL/Linux GPU and Blender GUI foundation — `docs/phases/02-host-runtime-foundation.md`
- [ ] Phase 03 — Reproducible native MoonRay runtime — `docs/phases/03-moonray-native-runtime.md`
- [ ] Phase 04 — Direct MoonRay Bridge prototype and IPC contract — `docs/phases/04-direct-bridge-prototype.md`
